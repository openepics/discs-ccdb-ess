...
public class AuditInterceptor {
    ...
    public Object createAuditLog(InvocationContext context) throws Exception {
        ...
        if (context.getMethod().getAnnotation(CRUDOperation.class) != null) {
            ...
            if (entity instanceof Property) {
            ...
            } else if (entity instanceof SlotProperty) {
                final SlotProperty slotProperty = (SlotProperty) entity;
            ...
            } else if (entity instanceof DeviceProperty) {
                final DeviceProperty deviceProperty = (DeviceProperty) entity;
            ...
            } else if (entity instanceof ComptypeProperty) {
                final ComptypeProperty comptypeProperty = (ComptypeProperty) entity;
                ...
                final AlignmentProperty alignmentProperty = (AlignmentProperty) entity;
    ...
    private void makeAuditEntry(EntityTypeOperation oper, EntityType entityType, String key, String entry, Long id) {
        AuditRecord arec = new AuditRecord(new Date(), oper, loginManager.getUserid(), entry, id);
