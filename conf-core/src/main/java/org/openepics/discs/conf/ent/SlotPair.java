...
@NamedQueries({
    ...
    @NamedQuery(name = "SlotPair.findFirstTwoSlotPairsByChildAndRelation", query = "SELECT s FROM SlotPair s WHERE s.childSlot = :childSlot AND s.slotRelation.name = :relationName"),
