...
(
	...
	UNIQUE UQ_uniq_align_prop(alignment_record, property),
	KEY (alignment_record),
	KEY (property)
...
(
	...
	oper CHAR(1) NOT NULL COMMENT 'c-created,d-deleted,u-updated,l-login,o-logout',
	user VARCHAR(64) NOT NULL,
	entity_type CHAR(16) COMMENT 'Slot, device, or component type. ',
...
(
	component_type_id INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
	name CHAR(32) NOT NULL,
	description VARCHAR(255),
	super_component_type INTEGER UNSIGNED COMMENT 'super (more general) type',
	modified_at DATETIME NOT NULL,
	modified_by VARCHAR(64) NOT NULL,
	version INTEGER NOT NULL DEFAULT 0 COMMENT 'for concurrency control',
	PRIMARY KEY (component_type_id),
	UNIQUE UQ_component_type_name(name),
...
(
	artifact_id INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
	component_type INTEGER UNSIGNED NOT NULL,
	name VARCHAR(128) NOT NULL,
	is_internal BOOL NOT NULL DEFAULT TRUE COMMENT 'if true, it is an internal artifact which can be downloaded. otherwise, it is a link to an external resource.',
...
(
	comptype_asm_id INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
	parent_type INTEGER UNSIGNED NOT NULL COMMENT 'id of the parent type',
	child_position VARCHAR(16) NOT NULL COMMENT 'position of a child type in an assembly',
	child_type INTEGER UNSIGNED NOT NULL COMMENT 'id of the child type',
	description VARCHAR(255),
	modified_at DATETIME NOT NULL,
	modified_by VARCHAR(64) NOT NULL,
	version INTEGER NOT NULL DEFAULT 0,
	PRIMARY KEY (comptype_asm_id),
	UNIQUE UQ_uniq_key(parent_type, child_position),
	KEY (child_type),
	KEY (parent_type)
...
(
	...
	UNIQUE UQ_uniq_comptype_prop(component_type, property),
	KEY (component_type),
	KEY (unit),
	KEY (property)
...
(
	...
	UNIQUE UQ_uniq_device_prop(device, property),
	KEY (unit),
	KEY (property),
	KEY (device)
...
(
	...
	oper CHAR(1) NOT NULL COMMENT 'operation',
	PRIMARY KEY (privilege_id),
	KEY (role)

) ENGINE=InnoDB COMMENT='Each row is a privilege given to a role';
...
(
	...
	component_type INTEGER UNSIGNED NOT NULL COMMENT 'Associated component type',
...
(
	...
	UNIQUE UQ_uniq_slot_prop(slot, property),
	KEY (property),
	KEY (unit),
	KEY (slot)
...
ALTER TABLE comptype_artifact ADD CONSTRAINT FK_comptype_artifact_component_type 
	FOREIGN KEY (component_type) REFERENCES component_type (component_type_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE comptype_asm ADD CONSTRAINT FK_comptype_asm_child 
	FOREIGN KEY (child_type) REFERENCES component_type (component_type_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE comptype_asm ADD CONSTRAINT FK_comptype_asm_parent 
	FOREIGN KEY (parent_type) REFERENCES component_type (component_type_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE comptype_property ADD CONSTRAINT FK_comptype_property_component_type 
	FOREIGN KEY (component_type) REFERENCES component_type (component_type_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE comptype_property ADD CONSTRAINT FK_comptype_property_unit 
...
ALTER TABLE device ADD CONSTRAINT FK_device_component_type 
	FOREIGN KEY (component_type) REFERENCES component_type (component_type_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE device_property ADD CONSTRAINT FK_device_property_unit 
	FOREIGN KEY (unit) REFERENCES unit (unit_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE privilege ADD CONSTRAINT FK_privilege_role 
...
ALTER TABLE slot ADD CONSTRAINT FK_slot_component_type 
	FOREIGN KEY (component_type) REFERENCES component_type (component_type_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE slot_property ADD CONSTRAINT FK_slot_property_unit 
	FOREIGN KEY (unit) REFERENCES unit (unit_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;
