...
DROP TABLE IF EXISTS comp_type_asm CASCADE;
DROP TABLE IF EXISTS component_type CASCADE;
DROP TABLE IF EXISTS component_type_property CASCADE;
DROP TABLE IF EXISTS comptype_log_rec CASCADE;
DROP TABLE IF EXISTS config CASCADE;
DROP TABLE IF EXISTS ct_artifact CASCADE;
...
DROP TABLE IF EXISTS ls_artifact CASCADE;
DROP TABLE IF EXISTS pc_artifact CASCADE;
...
(
	...
	modified_by VARCHAR(64) NOT NULL,
	version INTEGER NOT NULL DEFAULT 0 COMMENT 'for concurrency control',
	PRIMARY KEY (component_type, property),
	KEY (property),
	KEY (component_type)
...
(
	ctype_log_rec_id INTEGER UNSIGNED NOT NULL COMMENT 'Each row is a ',
	component_type CHAR(8) NOT NULL,
...
(
	dev_log_rec_id INTEGER UNSIGNED NOT NULL,
	device INTEGER UNSIGNED NOT NULL,
	log_time TIMESTAMP NOT NULL,
	user VARCHAR(64) NOT NULL,
	entry TEXT NOT NULL,
...
CREATE TABLE pc_artifact
(
	artifact_id INTEGER NOT NULL,
	device INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
	name VARCHAR(128),
	description VARCHAR(255) NOT NULL,
	uri TEXT NOT NULL,
	modified_by VARCHAR(64) NOT NULL,
...
(
	slot_log_rec_id INTEGER UNSIGNED NOT NULL,
	slot INTEGER UNSIGNED NOT NULL,
	log_time TIMESTAMP NOT NULL,
	user VARCHAR(64) NOT NULL,
	entry TEXT NOT NULL,
...
(
	...
	version INTEGER NOT NULL DEFAULT 0 COMMENT 'for concurrency control',
	PRIMARY KEY (slot_relation, parent_slot, child_slot),
	KEY (slot_relation),
	KEY (child_slot),
	KEY (parent_slot)
...
ALTER TABLE comp_type_asm ADD CONSTRAINT FK_composition_member_child 
	FOREIGN KEY (child_type) REFERENCES component_type (component_type_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE comp_type_asm ADD CONSTRAINT FK_composition_member_parent 
...
ALTER TABLE component_type_property ADD CONSTRAINT FK_tcomp_property_value_component_property 
	FOREIGN KEY (property) REFERENCES property (property_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE component_type_property ADD CONSTRAINT FK_tcomp_property_value_component_type 
	FOREIGN KEY (component_type) REFERENCES component_type (component_type_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE ct_artifact ADD CONSTRAINT FK_ct_artifact_component_type 
	FOREIGN KEY (component_type) REFERENCES component_type (component_type_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;
...
ALTER TABLE ls_artifact ADD CONSTRAINT FK_lc_artifact_logical_component 
	FOREIGN KEY (slot) REFERENCES slot (slot_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;

ALTER TABLE pc_artifact ADD CONSTRAINT FK_pc_artifact_physical_component 
	FOREIGN KEY (device) REFERENCES device (device_id)
	ON DELETE RESTRICT ON UPDATE CASCADE;
