...
--
-- Dumping data for table `alignment_record`
--

LOCK TABLES `alignment_record` WRITE;
/*!40000 ALTER TABLE `alignment_record` DISABLE KEYS */;
/*!40000 ALTER TABLE `alignment_record` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `component_type_property` (`component_type`, `property`, `type`, `value`, `modified_at`, `modified_by`, `version`) VALUES ('a1','Bending-Radius',NULL,'13.8','2014-04-23 15:43:06','user',0),('a2','Bending-Radius',NULL,'12','2014-04-09 02:39:15','user',0),('a3','Aperture','a',NULL,'2014-04-07 16:39:24','user',0),('QSM1','Aperture',NULL,NULL,'2014-04-09 09:59:14','user',0),('QSM1','Bending-Radius',NULL,NULL,'2014-04-09 09:59:21','user',0);
...
--
-- Dumping data for table `layout_slot_property`
--

LOCK TABLES `layout_slot_property` WRITE;
/*!40000 ALTER TABLE `layout_slot_property` DISABLE KEYS */;
/*!40000 ALTER TABLE `layout_slot_property` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping data for table `ls_artifact`
--

LOCK TABLES `ls_artifact` WRITE;
/*!40000 ALTER TABLE `ls_artifact` DISABLE KEYS */;
/*!40000 ALTER TABLE `ls_artifact` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-04-23 16:32:33
